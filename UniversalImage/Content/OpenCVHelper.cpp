...
namespace UniversalImage{
	bool OpenCVHelper::TryConvert(Windows::Graphics::Imaging::SoftwareBitmap^ from, cv::Mat& convertedMat)
	{
	...
	bool OpenCVHelper::GetPointerToPixelData(Windows::Graphics::Imaging::SoftwareBitmap^ bitmap,
